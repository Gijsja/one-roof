...
- Outside City parallax: isolated Unity 6000.3.24f1 compile passed; focused presenter tests 2/2, full EditMode 451/453 (same two pristine-HEAD presentation failures), and PlayMode 6/6 passed. A screenshot-led visual refinement then passed focused EditMode 3/3 and PlayMode 1/1. See `Handoffs/Archive/HANDOFF_2026-09-23_outside-city-parallax.md`.
